...
class FoodDelayEvaluateScreen extends StatefulWidget {
  final String title;
  const FoodDelayEvaluateScreen({super.key, required this.title});

  @override
  State<FoodDelayEvaluateScreen> createState() =>
      _FoodDelayEvaluateScreenState();
}

class _FoodDelayEvaluateScreenState extends State<FoodDelayEvaluateScreen> {
  ...
  void initState() {
    ...
    sec1Words = "Target: Rational Override & Value Assessment".split(' ');
    sec2Words =
        "You are no longer just delaying the physical urge; you are actively interrogating it. Break the illusion of the craving."
            .split(' ');
    sec3Words = "Instructions:".split(' ');
    sec4Words =
        "When faced with a highly craved food, start the delay timer. Do not just wait. Force your mind to answer these exact questions analytically:\n• Why exactly do I crave this right now?\n• Is this substance beneficial or destructive to my biological health?\n• How incredibly brief is the actual sensory pleasure of eating this?\n• Is the true cost (health, money, and my discipline) genuinely worth this fleeting moment of enjoyment?"
            .split(' ');
    sec5Words = "Why this works:".split(' ');
    sec6Words =
        "By forcing your brain to logically analyze the craving, you instantly shift neural activity away from the emotional, impulsive reward center and into the analytical Prefrontal Cortex. You are stripping away the emotional power of the food and seeing it purely as a biological transaction."
            .split(' ');
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/images/fooddelay_evaluate.png',
              fit: BoxFit.cover,
            ),
          ),
