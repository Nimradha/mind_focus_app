...
class NoExternalFoodScreen extends StatefulWidget {
  const NoExternalFoodScreen({super.key});

  @override
  State<NoExternalFoodScreen> createState() => _NoExternalFoodScreenState();
}

class _NoExternalFoodScreenState extends State<NoExternalFoodScreen> {
  ...
  void initState() {
    ...
    sec1Words = "Target: Impulse Monetization & Resource Retention".split(' ');
    sec2Words =
        "Eating out is a tax on both your biological health and your mental discipline. Today, you cut off all external dependencies."
            .split(' ');
    sec3Words = "Instructions:".split(' ');
    sec4Words =
        "For the next 24 hours, consume ONLY food prepared at home. Zero takeout, zero street food, zero external snacks. When a strong urge hits to buy a specific food, or when you calculate your usual daily external food cost, figure out that exact monetary amount. Log this exact amount into your \"Discipline Wallet\" below."
            .split(' ');
    sec5Words = "Why this works:".split(' ');
    sec6Words =
        "You are not just suppressing a dopamine craving; you are actively converting it into a quantifiable metric of wealth. By visually tracking the exact financial value of your resisted urges, you rewire your brain's reward system. You replace the fleeting, primitive pleasure of junk food with the highly advanced, executive satisfaction of resource accumulation and self-mastery."
            .split(' ');
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/images/noexternalFood.png',
              fit: BoxFit.cover,
            ),
          ),
