...
class NoScrollScreen extends StatefulWidget {
  const NoScrollScreen({super.key});

  @override
  State<NoScrollScreen> createState() => _NoScrollScreenState();
}

class _NoScrollScreenState extends State<NoScrollScreen> {
  ...
  void initState() {
    ...
    sec1Words = "Target: Dopamine Baseline Calibration".split(' ');
    sec2Words =
        "Infinite scrolling is a subconscious reflex designed to harvest your attention and fragment your mind. Today, you take your attention back."
            .split(' ');
    sec3Words = "Instructions:".split(' ');
    sec4Words =
        "For the entire day, completely eliminate all forms of \"doomscrolling\" (Reels, TikTok, Shorts, endless Timelines). You may use your device strictly for intentional purposes (calls, direct messages, specific research). If you catch your thumb mindlessly swiping up on any feed, STOP immediately. Lock the device and put it down."
            .split(' ');
    sec5Words = "Why this works:".split(' ');
    sec6Words =
        "Infinite scrolling continuously drips cheap dopamine, keeping your brain in a state of low-level chronic stimulation. This destroys your attention span. By imposing a hard stop on mindless scrolling for a full day, you force your dopamine receptors to reset, profoundly increasing your raw mental endurance for deep, high-value work."
            .split(' ');
